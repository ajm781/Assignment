  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item">
          <a class="nav-link fs-4"  href="technician_myprofile">My Profile</a>
        </li>
        <li class="nav-item">
          <a class="nav-link fs-4"  href="technician_patients">Patients</a>
        </li>
...
<div class="wrapper">
    ...
    <form  id="registraion_form"  > 
         ...
         <div style="font-size: 40px; margin-left: 180px; margin-bottom: 100px;color:white; ">Edit Doctor </div>
