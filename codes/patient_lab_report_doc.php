...
<div class="s100" id="s1200" style="margin-left:auto; margin-right:auto; width:50%; " >
   ...
   <br>
    ...
    <div style="text-align: right;">
        <h20 style="text-align: right;"> 8th Avenue, </h20>
    </div>
    <div style="text-align: right;">
        <h20 style="text-align: right;"> Colombo 5, </h20>
    </div>
    <div style="text-align: right;">
   ...
   <br>
    ...
    <div style="text-align: left;">
        <h20 style="text-align: left;"> Patient Id :<?php  echo  $_SESSION['lab_rep']['patient_id']; ?> </h20>
   </div>
    <div style="text-align: left;">
        <h20 style="text-align: left;"> Patients Name :<?php  echo  $_SESSION['lab_rep']['patient_fname']; ?> <?php  echo  $_SESSION['lab_rep']['patient_lname']; ?> </h20>
    </div> 
    <div style="text-align: left;">
        <h20 style="text-align: left;"> Appointment Id : <?php  echo  $_SESSION['lab_rep']['appointment_ref_num']; ?></h20>
    </div> 
    <div style="text-align: left;">
        <h20 style="text-align: left;"> Date of Birth : <?php  echo  $_SESSION['lab_rep']['patient_dob']; ?></h20>
    </div>
    <div style="text-align: left;">
        <h20 style="text-align: left;"> Doctor :Dr. <?php  echo  $_SESSION['lab_rep']['doctor_lname']; ?> </h20>
    </div>  
    <div style="text-align: left;">
        <h20 style="text-align: left;"> Technician :<?php  echo  $_SESSION['lab_rep']['technician_fname']; ?> <?php  echo  $_SESSION['lab_rep']['technician_lname']; ?> </h20>
    </div>    
   ...
   <br>
    ...
    <div style="text-align: left;">
        <h20 style="text-align: left;"> Date Created :<?php  echo  $_SESSION['lab_rep']['date_of_issue']; ?>  </h20>
    </div>   
  ...
  <div style="width:100%;">
    ...
    <div style="float:left; width:40%"><?php  echo  $_SESSION['lab_rep']['test_type']; ?></div>  
    <div style="float:left; width:40%"><?php  echo  $_SESSION['lab_rep']['test_result']; ?></div>
    <div style="float:left; width:20%"><?php  echo  $_SESSION['lab_rep']['test_ref']; ?></div>
