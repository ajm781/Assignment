...
<div style="font-size: 80px;  margin-bottom: 100px;  color:black; ">PATIENTS</div>
...
<?php
   ...
   $query2 = "SELECT user_det.email ,user_det.fname , user_det.lname  FROM user_det JOIN user_role ON user_det.user_id=user_role.user_id WHERE role_id=1";
