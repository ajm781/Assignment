...
while($row=mysqli_fetch_array($result)) {
  ...
  echo "<td> <button border:none class='varView' onclick='patientUpdate(this)'><img src='view.png' ></button> </td>";
...
function patientUpdate(r) {
  ...
  $.ajax( {url: 'process.php' ,type: 'post',data: {first_x: first_x },success:function(response) {var output=jQuery.parseJSON(response);if(output.data=='valid') {location.href="technician_lab_report_doc.php";} }});}
</script>
