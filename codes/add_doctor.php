...
<script type= "text/javascript" src="/scripts/doctor_add_script.js" ></script>
...
<div class="wrapper">
    ...
    <form  id="registraion_form"  > 
         ...
         <div style="font-size: 40px; margin-left: 180px; margin-bottom: 100px;color:white; ">Add Doctor </div>
         ...
         <div>
               ...
               <input id="txt_email" name="email" class="txt_input"  type="text" placeholder="" >
         ...
         <div>
               ...
               <input id="txt_fname" name="fname" class="txt_input"  type="text" placeholder="" >
               <span class="require"> * </span>
         </div>
         ...
         <div>
               ...
               <input id="txt_lname" name="lname" class="txt_input"  type="text" placeholder="" >
               <span class="require"> * </span>
         ...
         <div>
               ...
               <input id="user_dob" name="dob" class="txt_input"  type="date" value="" type="text" />
               <span class="require"> * </span>          
         ...
         <div>
               ...
               <input id="txt_contact" name="contact" class="txt_input"  type="text" placeholder=""  >
               <span class="require"> * </span>          
         ...
         <div>
               ...
               <input id="txt_address" name="address" class="txt_input"  type="text" placeholder="" >
               <span class="require"> * </span>
         ...
         <div>
               ...
               <input id="txt_city" name="city" class="txt_input"  type="text" placeholder=""  >
               <span class="require"> * </span>
         ...
         <div>
               ...
               <select id="specialization" name="specialization" class="txt_input"  >
               <option value="" disabled selected hidden >  Select Specialization </option>
   <?php 

    $connection = mysqli_connect("localhost", "root" , "" , "abc_lab" );

   $query2 = "SELECT specialization_type FROM specialization_det";
   $result = mysqli_query($connection, $query2);

   while($row=mysqli_fetch_array($result)){
      echo "<option value='".$row['specialization_type']."'   >  ".$row['specialization_type']."</option>"; 
   } 
